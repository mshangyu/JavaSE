...
public class demo {
	public static void main(String[] args) throws ClassNotFoundException {
		...
		String in_sql = "INSERT tdb_goods (goods_id,goods_name,cate_id,brand_id,goods_price,is_show,is_saleoff) VALUES(28,'高博',45,44,'99',DEFAULT,DEFAULT);";
		String del_sql = "DELETE FROM tdb_goods WHERE goods_id=28";
		// 1、加载驱动
